...
<head>
  ...
  <title>Client Progress Summary – FitNation Trainer</title>
...
<div class="fn-admin-shell">
  ...
  <main class="fn-admin-main">
    <header class="fn-admin-header">
      <div>
        <a href="${ctx}/trainers/clients/${userId}/progress" class="fn-admin-btn-secondary" style="margin-right: 0.5rem;">← Back to Progress</a>
